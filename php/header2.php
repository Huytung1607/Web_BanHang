    ...
    <div class="header-container">
        <div class="header-top">
            <div class="header-left">
                ...
                <a href="https://www.facebook.com/ascrea.03"><i class="iconn bi bi-facebook"></i>                </a>
            ...
            <div class="header-right">
                ...
                <?php if ($isLoggedIn): ?>
                    <a href="../php/home.php" id="click"><i class="iconn bi bi-person-circle" ></i> <span><?= $_SESSION['username']; ?></span></a>
                    
                    <a href="../php/logout.php" id="click"><i class="iconn bi bi-box-arrow-right"></i> Đăng xuất</a>
                <?php else: ?>
                    <a href="../php/dangnhap.php" id="click"><i class="iconn bi bi-person"></i> Đăng nhập/Đăng ký</a>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="header-middle">
            <div class="logo">
                ...
                <h2><span><a href="../php/trangchu.php">TQT</a></span></h2>
            </div>
...
<nav class="main-menu">
    ...
    <ul>
        ...
        <li><a href="../php/sp1.php">TẤT CẢ SẢN PHẨM</a>
            <ul class="dropdown">
            <li><a href="../php/home.php?category=kitchen">THIẾT BỊ NHÀ BẾP</a></li>
            <li><a href="../php/home.php?category=cleaning">THIẾT BỊ VỆ SINH</a></li>
            <li><a href="../php/home.php?category=climate">THIẾT BỊ LÀM MÁT & SƯỞI ẤM</a></li>
            <li><a href="../php/home.php?category=furniture">ĐỒ NỘI THẤT</a></li>
            <li><a href="../php/home.php?category=other">DỤNG CỤ KHÁC</a></li>
            </ul>
        </li>
            <li><a href="../php/home.php?category=kitchen">THIẾT BỊ NHÀ BẾP</a></li>
            <li><a href="../php/home.php?category=cleaning">THIẾT BỊ VỆ SINH</a></li>
